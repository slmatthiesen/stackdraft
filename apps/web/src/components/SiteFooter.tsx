...
const GITHUB_URL = "https://github.com/slmatthiesen/stackdraft";
  ...
  return (
    <>
      <footer className="site-footer">
        <span className="site-footer__mark">Stackdraft</span>
      ...
      {panel && (
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-label={panel === "about" ? "About Stackdraft" : "Terms and disclaimer"}
...
function AboutContent(): JSX.Element {
  return (
    <article className="info-doc">
      <h2>About Stackdraft</h2>
      <p>
        Stackdraft turns a plain-English description of a system into a recommended,
      ...
      <p className="info-doc__note">
        Stackdraft is not affiliated with, endorsed by, or sponsored by Amazon Web
...
function TermsContent(): JSX.Element {
  return (
    <article className="info-doc">
      ...
      <p>
        By using Stackdraft you agree to these terms. In plain language: this is a free,
      ...
      <p>
        ...
        infrastructure-as-code that Stackdraft generates is a <strong>starting point for a
      ...
      <p>
        ...
        <strong> real, billable resources</strong> in your own cloud account. Stackdraft
      ...
      <h3>No warranty</h3>
      <p>
        Stackdraft is provided <strong>“as is” and “as available,” without warranty of any
      ...
      <p>
        To the maximum extent permitted by law, the creator of Stackdraft shall not be
      ...
      <p>
        Stackdraft does not provide architectural, security, financial, or legal advice.
